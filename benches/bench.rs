...
pub const ISCSI: Crc<u32> = Crc::<u32>::new(&CRC_32_MPEG_2);
pub const ISCSI_CLMUL: Crc<ClMul<u32>> = Crc::<ClMul<u32>>::new(&CRC_32_MPEG_2);
pub const ISCSI_SLICE16: Crc<Slice16<u32>> = Crc::<Slice16<u32>>::new(&CRC_32_MPEG_2);
pub const ISCSI_BYTEWISE: Crc<Bytewise<u32>> = Crc::<Bytewise<u32>>::new(&CRC_32_MPEG_2);
pub const ISCSI_NOLOOKUP: Crc<NoTable<u32>> = Crc::<NoTable<u32>>::new(&CRC_32_MPEG_2);
